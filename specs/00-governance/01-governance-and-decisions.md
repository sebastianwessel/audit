...
| DEC-007 | One public Bun CLI package with deep domain folders and an explicit packaged entry point. | Reuse without premature workspace complexity while making the supported operator boundary clear. | Package build/help, metadata, license, and release-workflow checks. |
