...
/**
 * The deterministic conformance provider may exercise reviewed-plan workflow
 ...
 * It validates the selected source digest and reviewed-plan fixture without
...
function corpusError(message: string): SecurityReviewerError {
  return new SecurityReviewerError('invalid-input', `Invalid evaluation corpus: ${message}`);
}
