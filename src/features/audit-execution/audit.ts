...
import {
  type AuditVerificationResultWithObservation,
  type CandidateAwareCheckpointUpdate,
  type CandidateAwareModelStageContext,
  candidateAwareOperationalError,
  collectCandidateAwareResults,
  runCandidateAwareStage,
} from './candidate-aware/index.js';
import {
...
import {
  hasCandidateBlindPostureContradiction,
...
export type {
  AuditVerificationResultWithObservation,
  CandidateAwareCheckpointUpdate,
  CandidateAwareModelStageContext,
} from './candidate-aware/index.js';
    ...
    const verificationCollection = await collectCandidateAwareResults(
      verifiedFindings.map(async (hypothesis, index) => {
        return runCandidateAwareStage({
          ...
          retryUnfinished: input.retryUnfinished === true,
          onCheckpoint: input.onCandidateAwareCheckpoint,
          candidateAwareDispatchPool,
          vector,
          phase: 'verification',
