...
export function stageEvidenceCoverage(input: {
  ...
  terminalFindingEvidenceMatches?: readonly TerminalFindingEvidenceMatch[];
}): EvidenceStageCoverage {
  if (input.roleTraces !== undefined) {
    return coverageFromRoleTraces(input.roleTraces, input.terminalFindingEvidenceMatches);
  }
...
function coverageFromRoleTraces(
  roleTraces: readonly ExpectedEvidenceRoleTrace[],
  terminalFindingEvidenceMatches: readonly TerminalFindingEvidenceMatch[] | undefined,
): EvidenceStageCoverage {
  ...
  return EvidenceStageCoverageSchema.parse({
    ...
    roleTraces,
    ...(terminalFindingEvidenceMatches === undefined ? {} : { terminalFindingEvidenceMatches }),
  });
}
