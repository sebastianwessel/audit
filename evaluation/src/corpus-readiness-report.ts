...
export function renderCorpusReadinessReport(report: CorpusReadinessReport): string {
  const lines = [
    ...
    `- Internal development-calibration evidence: **${report.developmentCalibrationAvailable ? 'available' : 'unavailable'}** (not a readiness, model-quality, provider-selection, or reliability claim)`,
    ...
    '## Evidence counts',
    '',
    '| Cases | Real-world cases | Paired cases | Real-world pairs | Human-dual-reviewed pairs | Human-dual-reviewed patched negatives | Human-dual-reviewed holdout pairs | Human-dual-reviewed language families |',
    '| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    ...
    '',
    '| Declared AI-assisted pairs | Eligible pairs | High uncertainty | Open conflict | Causal patch unconfirmed |',
    '| ---: | ---: | ---: | ---: | ---: |',
    `| ${report.counts.developmentCalibrationDeclaredProjectCount} | ${report.counts.developmentCalibrationEligibleProjectCount} | ${report.counts.developmentCalibrationHighUncertaintyProjectCount} | ${report.counts.developmentCalibrationOpenConflictProjectCount} | ${report.counts.developmentCalibrationCausalPatchUnconfirmedProjectCount} |`,
    '',
    '## Development control-family coverage',
    '',
    '| Control family | Real-world paired projects | Human-dual-reviewed paired projects |',
    '| --- | ---: | ---: |',
